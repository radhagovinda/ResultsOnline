...
CREATE TABLE `ro_progressreport`(`ID` int NOT NULL AUTO_INCREMENT, `SchoolID` int NOT NULL, `Student` int NULL, `Examination` int NULL, `Subject` int NULL, `Theoritical` decimal(32,0) NULL, `Practical` decimal(32,0) NULL, `Oral` decimal(32,0) NULL, PRIMARY KEY (`ID`))CHARACTER SET utf8;
